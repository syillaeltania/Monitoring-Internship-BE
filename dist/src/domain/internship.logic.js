...
export const calculateStatus = (startDate, endDate, today = new Date(), manuallyTerminated = false) => {
...
export const calculateMonthlyCost = (input) => {
...
export const evaluateReplacementStatus = (input) => {
    if (input.minimumInstitutionNeed > 0 && input.activeInstitutionCount <= 0)
        return 'URGENT_EMPTY';
...
//# sourceMappingURL=internship.logic.js.map